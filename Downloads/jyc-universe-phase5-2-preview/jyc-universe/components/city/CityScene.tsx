  ...
  return (
    <MotionConfig reducedMotion="user">
      ...
      >
        ...
        {/* Hint: fades away after the first drag */}
        <motion.p
          className="pointer-events-none absolute bottom-8 left-1/2 z-20 hidden -translate-x-1/2 text-center text-sm text-bone/50 md:block md:bottom-10"
          initial={{ opacity: 0 }}
          animate={{ opacity: explored ? 0 : 1 }}
          transition={{ duration: 0.8, delay: explored ? 0 : 2 }}
        >
          Drag to look around · select a building to enter
        </motion.p>
